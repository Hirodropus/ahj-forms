...
[![Build and Deploy](https://github.com/Hirodropus/ahj-forms/actions/workflows/deploy.yml/badge.svg)](https://github.com/Hirodropus/ahj-forms/actions/workflows/deploy.yml)

**GitHub Pages**: [https://hirodropus.github.io/ahj-forms/](https://hirodropus.github.io/ahj-forms/)

Реализация виджета Popover без jQuery, в точности как в Bootstrap.  
Виджет появляется сверху от элемента-триггера, центрируется по горизонтали, содержит заголовок и текст.  
Кнопка красная (Danger), как на макете.
...
npm test    # запуск авто-тестов (JSDOM)
